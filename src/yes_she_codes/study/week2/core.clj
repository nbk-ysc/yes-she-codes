(ns yes-she-codes.study.week2.core
  (:require [yes-she-codes.study.week2.logic.cliente :as logic.cliente]
            [yes-she-codes.study.week2.logic.cartao :as logic.cartao]
            [yes-she-codes.study.week2.logic.compra :as logic.compra]
            [yes-she-codes.study.week2.adapter.cliente :as adapter.cliente]
            [yes-she-codes.study.week2.adapter.cartao :as adapter.cartao]
            [yes-she-codes.study.week2.adapter.compra :as adapter.compra]))
