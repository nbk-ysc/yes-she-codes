...
; [ID_ENTIDADE ATRIBUTO VALOR TX_ID TRUE/FALSE] => DATOM
; {:compra/data "2022-06-03" :compra/valor 100M}
; {:compra/data "2022-06-01" :compra/valor 200M}

; [12 ... dados da transação]
; [159357 :compra/data "2022-06-03" 12 true]
; [159357 :compra/valor 100M 12 true]
; [13 ... dados da transação]
; [112233 :compra/data "2022-06-01" 13 true]
; [112233 :compra/valor 200M 13 true] =>
; [159357, 112233] => [{:compra/data "2022-06-03" :compra/valor 100M}
;                      {:compra/data "2022-06-01" :compra/valor 200M}}

; (lista-compras-por-cartao! (d/db conexao) 123)
