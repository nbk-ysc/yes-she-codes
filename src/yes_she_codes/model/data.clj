...
(def massa-clientes [["Feiticeira Escarlate" "000.111.222-33" "feiticeira.poderosa@vingadoras.com.br"]
...
(def massa-cartoes [[1234123412341234 111 "2023-01" 1000M "000.111.222-33"]
...
(def massa-compras [["2022-01-01" 129.90M "Outback" "Alimentação" 1234123412341234]
...
(defn lista-clientes []
  (mapv criar-cliente massa-clientes))
