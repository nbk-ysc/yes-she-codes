(ns yes-she-codes.estudos.week1.core
  (:require [yes-she-codes.estudos.week1.input.csv-reader :as i.csv]
            [yes-she-codes.estudos.week1.input.hard-code :as i.hc]
            [yes-she-codes.estudos.week1.logic.logic :as l]
