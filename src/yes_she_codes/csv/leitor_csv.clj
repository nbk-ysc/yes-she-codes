...
(defn- converte-valores-na-linha
  [funcoes-de-conversao linha]
...
(def csv->cartao
  [y.util/str->long y.util/str->long time/year-month bigdec identity])

(def csv->compra
  [time/local-date bigdec identity identity y.util/str->long])
