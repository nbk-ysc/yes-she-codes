...
(deftest nova-compra-test
  (testing "Testando nova compra multiplas vezes"
    (are [data valor	estabelecimento	categoria	cartao esperado] (= esperado (nova-compra data valor	estabelecimento	categoria	cartao))
  ...
  (testing "Testando com cartao invalido"
    (are [data valor estabelecimento	categoria	cartao] (thrown? Exception (nova-compra data valor	estabelecimento	categoria	cartao))
