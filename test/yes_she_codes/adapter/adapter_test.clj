...
(t/deftest dado-bruto->model-test
  ...
  (t/testing "adapter dos dados dos clientes"
    (let [file-path          "/Users/vitoria.galli/Documents/alura/bootcamp/yes-she-codes/data/clientes.csv"
      ...
      (t/is (= (a/dado-bruto->model file-path fn-parse fn-model) estrutura-esperada))))

  (t/testing "adapter dos dados dos cartões"
    (let [file-path          "/Users/vitoria.galli/Documents/alura/bootcamp/yes-she-codes/data/cartoes.csv"
          ...
          resultado           (a/dado-bruto->model file-path fn-parse fn-model)
  ...
  (t/testing "adapter dos dados das compras"
    (let [file-path            "/Users/vitoria.galli/Documents/alura/bootcamp/yes-she-codes/data/compras.csv"
